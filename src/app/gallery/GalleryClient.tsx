...
export default function GalleryClient() {
  ...
  const filterTabs = [
    ...
    { id: "custom-cakes", label: "Custom Models" },
    { id: "wedding-tier", label: "Wedding Tiers" },
  ];
                ...
                <div className="relative h-72 sm:h-80 w-full overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                    ...
                    {product.isBestseller && (
                      <span className="text-[11px] font-extrabold px-3 py-1 rounded-full bg-[#FF8A00] text-white shadow-md">
                        ⭐ Bestseller
                      </span>
                    )}
                  </div>
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="text-xl font-extrabold text-[#FFF7EA]">
                      ₹{product.offerPrice.toLocaleString("en-IN")}
                    </div>
                    {product.originalPrice > product.offerPrice && (
                      <div className="text-xs text-[#DBD8C0]/60 line-through">
                  ...
                  <div className="absolute bottom-4 right-4 flex items-center gap-2">
                    <button
                      ...
                      className={`py-2 px-3.5 rounded-xl font-bold text-xs flex items-center gap-1.5 transition-all shadow-md ${
                        isAdded
                          ? "bg-[#C1DD13] text-[#020001]"
                          : "bg-[#FF8A00] hover:bg-[#ff991a] text-white"
                      }`}
                    >
                      {isAdded ? (
                        <>
